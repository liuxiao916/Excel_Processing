...
names_Series = pd.read_excel(io='data/25/25_name.xlsx')
...
class2_Series = pd.read_excel(io='data/25/25-9-19.xls')
...
class3_Series = pd.read_excel(io='data/25/25-9-26.xls')
...
class4_Series = pd.read_excel(io='data/25/25-10-8.xls')
...
class5_Series = pd.read_excel(io='data/25/25-10-10.xls')
...
class6_Series = pd.read_excel(io='data/25/25-10-17.xls')
...
class7_Series = pd.read_excel(io='data/25/25-10-24.xls')
...
print(names_Series)
names_Series.to_csv('Result_25.csv')
